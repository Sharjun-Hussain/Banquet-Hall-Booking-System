...
export const AddHall = () => {
    ...
    const HandleSubmit = async (e) => {
        ...
        await axios.post("http://localhost:8000/admin/api/halls/add", JSON.stringify({ HallName, Location, Capacity, amenities, Price }), {
            headers: {
        ...
        <Container>
            <Row>
                <Col>
                    ...
                    <div className='text-center mt-2'><h3>List Hall</h3></div>
                    <div>
                        ...
                        <Form onSubmit={HandleSubmit} >
                            <Container className='mt-5'>
                                <Row>
                                    ...
                                    <label  htmlFor="validationCustom01" className="form-label">Amentities : </label>
                                        <div className='d-flex flex-column' id="validationCustom01" style={{fontSize:"18px", }}>
                                            <label className='mb-1'> <input type="checkbox" id="amenities1" className='' name="amenities" value="Parking facilities" onChange={HandleCheck}></input>Parking facilities</label>
...
<Col md={12} xs={12} className='d-grid mt-3'>
<Button type="submit"  >Add Hall</Button></Col>
                                </Row>
                            </Container>
